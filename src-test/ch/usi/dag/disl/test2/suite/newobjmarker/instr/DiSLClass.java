package ch.usi.dag.disl.test2.suite.newobjmarker.instr;
...
public class DiSLClass {
	...
	public static void afterAlloc(DynamicContext dc) {
		...
		ch.usi.dag.disl.test2.suite.newobjmarker.app.TargetClass tc = 
				dc.getStackValue(0, ch.usi.dag.disl.test2.suite.newobjmarker.app.TargetClass.class);
