...
JBORAT_AGENT_OPTS="1234,localhost,ipc.socket"
 ...
 java -noverify \
    ...
    -Xbootclasspath/p:../../test/lib/remote-runtime.jar:../../lib/jborat-runtime.jar:build/sharing2-runtime.jar \
    -agentpath:../../test/lib/${JBORAT_AGENT}=${JBORAT_AGENT_OPTS} \
    -cp ./bin \
    -jar /home/sarimbea/workspace/lib/dacapo-9.12-bach.jar -s small luindex
