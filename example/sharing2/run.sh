...
DISL_CLASS="./bin/ch/usi/dag/disl/example/sharing2/DiSLClass.class"
TARGET_CLASS="ch.usi.dag.disl.example.sharing2.TargetClass"

if [ "$1" = "pkg" ]
then
    # start server and take pid
    ant package -Dtest.name=sharing2
    ./runServer.sh
else
    # start server and take pid
