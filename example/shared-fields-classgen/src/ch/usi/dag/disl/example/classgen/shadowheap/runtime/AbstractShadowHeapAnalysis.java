package ch.usi.dag.disl.example.classgen.shadowheap.runtime;
...
import ch.usi.dag.disl.example.classgen.sharing.runtime.SharedFieldsAnalysis;
...
public abstract class AbstractShadowHeapAnalysis<T extends ShadowObject> {
	...
	private static final AbstractShadowHeapAnalysis<?> INSTANCE;
	...
	static {
		INSTANCE = new SharedFieldsAnalysis();
	}
